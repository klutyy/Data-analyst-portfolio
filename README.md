...
| 5 | 	[Событийная аналитика](https://github.com/klutyy/Data-analyst-portfolio/blob/main/Событийная%20аналитика.ipynb)| 	Выявление поведения пользователей мобильного приложения | Событийная аналитика, Plotly, SciPy |
